...
<div class="site-index">
    ...
    <div class="jumbotron">
        ...
        <p><a class="btn btn-lg btn-success" href="http://localhost/hsrr/basic/web/index.php?r=ticket%2Fcreate">Create Ticket</a></p>
    </div>
    ...
    <div class="body-content">
        ...
        <div class="row">
            ...
            <img src = "instruction.png"/>
                ...
                <p>Pleae click the about page to see the insuction on how to create a ticket.</p>

                <p><a class="btn btn-default" href="http://localhost/hsrr/basic/web/index.php?r=site%2Fabout">System Instructions &raquo;</a></p>
            </div>
            <div class="col-lg-4">
               <img src = "ticket.png"/>
                <h2>Ticket</h2>
                ...
                <p><a class="btn btn-default" href="http://localhost/hsrr/basic/web/index.php?r=ticket%2Fcreate">Create Ticket &raquo;</a></p>
            </div>
            <div class="col-lg-4">
               <img src = "hk.png"/>
